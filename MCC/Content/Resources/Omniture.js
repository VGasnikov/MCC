...
/* Set Campaign Variable */  
  	s.campaign=s.getQueryParam('cid,eid,pid,mid,iid,YM_MID',':');
  	s.campaign=s.getValOnce(s.campaign,'s_campaign',0);

/* Capture Page Name */
	s.eVar1="D=pageName";

/* Copy Channel to Prop1 */
	s.prop1="D=ch";
...
/* Capture Internal Search */
	s.prop3=s.getQueryParam("search");
	s.prop3.toLowerCase();
	s.eVar3="D=c3";

/* map previous value of internal search to sprop4 */	
	s.prop4=s.getPreviousValue(s.prop3,'gpv_prop4','');
  	s.eVar4="D=c4";

/* Capturing Page URLs */
      s.prop7=s.eVar7="D=g";

/* Capturing Page Views Generated by New vs. Repeat Visits */
	s.prop8=s.eVar8=s.getNewRepeat();
...
/* set campaign to variable and persist */
	var campaignPenton=s.getQueryParam('cid,eid,pid,mid,iid,YM_MID',':');
...
/* Give Value to Company Variable on Non-Company Pages */
	if (!s.eVar11){
				s.eVar11=s.prop11="no company"
			}
