        ...
        return this.each(function() {
            ...
            $(document).on("click", '.' + class_name + ' span.highlight', function() {
                ...
                if ($('.back_btn').length == 0) {
                    $('body').prepend('<img src="/Integrations/JQuery/Plugins/horizontalTree/images/back.png" class="back_btn" />');
                }
                call_structure();
            ...
            function highlightAllParents(_this) {
                if (_this.length > 0) {
                    _this = _this.closest('li').closest('ul').closest('li').children('div')
                    _this.addClass('parent');
...
//                        });
            ...
            if (edit_option) {
                $(document).on("click", '.' + class_name + ' span.edit_action', function() {
                    ...
                    var _this = $(this);
                    var editquery = '<form class="edit_data" method="post" action=""><img class="close" src="/Integrations/JQuery/Plugins/horizontalTree/images/close.png" /><input type="text" class="first_name" name="first_name" value="" placeholder="first name"><input type="checkbox"  value="" name="showhideval" id="hide" /><label for="hide">Hide Child Nodes</label><input type="submit" class="edit" name="submit" value="submit"></form>';
