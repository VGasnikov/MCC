...
google.bookmarkbubble.Bubble.prototype.changeMessage = function(message) {
  this.MESSAGE = message;
};

google.bookmarkbubble.Bubble.prototype.changeIcon = function(imageUrl, width, height) {
this.REL_ICON_ = imageUrl;
this.IMAGEWIDTH = width;
this.IMAGEHEIGHT = height;
};

google.bookmarkbubble.Bubble.prototype.showSamsung = function(showOnSamsung) {
if (showOnSamsung) {
	this.IPAD_USERAGENT_REGEX_ = /iPad|iPhone/;
} else {
	this.IPAD_USERAGENT_REGEX_ = /iPad|iPhone|samsung/;
}
};

google.bookmarkbubble.Bubble.prototype.MESSAGE = '<b>Install this web app on your phone:</b> Add it as a bookmark then add it to your Home Screen';
google.bookmarkbubble.Bubble.prototype.IMAGEWIDTH = '25px';
google.bookmarkbubble.Bubble.prototype.IMAGEHEIGHT = '19px';
...
google.bookmarkbubble.Bubble.prototype.MOBILE_SAFARI_USERAGENT_REGEX_ =
    /Android|BlackBerry|android|blackberry|windows|symbian|palm|samsung|nokia|sonyericsson|webos/;
 ...
 * @private
 */
google.bookmarkbubble.Bubble.prototype.IPAD_USERAGENT_REGEX_ = /iPad|iPhone/;

google.bookmarkbubble.Bubble.prototype.ANDROID_USERAGENT_REGEX_ = /Android|BlackBerry|android|blackberry|windows|symbian|palm|samsung|nokia|sonyericsson|webos/;
...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubbleInner.id = 'divMobileAddToHome';
  ...
  if (isAndroid) { bubbleInner.innerHTML = this.MESSAGE; }
  else {
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = this.MESSAGE;
  } else {
    bubbleInner.innerHTML = this.MESSAGE;
  }
  }
  ...
  icon.id = 'divMobileAddToHomeIcon';
  icon.style['float'] = 'left';
  icon.style.width = this.IMAGEWIDTH;
  icon.style.height = this.IMAGEHEIGHT;
  icon.style.margin = '-2px 7px 3px 5px';
  icon.src = this.REL_ICON_;
  //icon.style.background =
   //   '#fff url(' + this.REL_ICON_ + ') no-repeat -1px -1px';
  ...
  arrow.id = 'divMobileAddToArrow';
  arrow.style.backgroundImage = 'url(' + this.IMAGE_ARROW_DATA_URL_ + ')';0
  ...
  if (isIpad) {
    ...
    arrow.style.top = '-' + this.IMAGEHEIGHT;
  } else {
    arrow.style.bottom = '-' + this.IMAGEHEIGHT;
  }
  bubbleInner.appendChild(arrow);

  var close = document.createElement('a');
  close.id = 'divMobileAddToHomeClose';
